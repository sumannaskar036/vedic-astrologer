...
# --- 2. HARDENED FIREBASE BRIDGE ---
# This specific block manually constructs the credentials dictionary.
# It prevents "MalformedFraming" errors by ensuring every field is read correctly.
